...
<Figure imagePath="$/images/the-of-all-time.png" alt="screenshot of morpho's comment, which says in a panicked tone with some typoes: i didn't think it would send three times! omg i'm sorry!" caption="peak comedy" />
